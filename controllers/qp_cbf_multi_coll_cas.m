function [u, int_time] = qp_cbf_multi_coll_cas(x, u0, agent_ind, N, system_dynamics, backup_dynamics, barrier_func_collision, alpha, n_agents, casadi_F, options,u_lim,n,m)
