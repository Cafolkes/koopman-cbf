function u = koopman_qp_cbf_coll_static(x, u0, agent_ind, N, system_dynamics, backup_dynamics, barrier_func_collision, alpha, n_agents, func_dict, CK_pows, options, u_lim, n, m)
