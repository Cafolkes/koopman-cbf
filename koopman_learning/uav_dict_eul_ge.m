...
% Ground effect terms:
R = 0.1;
ge_thrust_fac = 1/(1-(R/(4*p(3)))^2);
D = [D;
    ge_thrust_fac*Omega(1)^2;
    ge_thrust_fac*Omega(2)^2;
    ge_thrust_fac*Omega(3)^2;
    ge_thrust_fac*Omega(4)^2]; 
...
matlabFunction(D,J,C,'file','koopman_learning/uav_D_eul_ge.m');